document.addEventListener('DOMContentLoaded', function() {
  ...
  style.textContent = `
    .fade-in.animated, [data-animate="fade-in"].animated {
      opacity: 1 !important;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מאור ביטוחי בריאות משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '5ffee155-414f-4c52-bc8b-5df3534bf310',
                    name: data.name || '',
                    email: data.email || '',
